...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-gray-200 to-gray-400 text-gray-700 text-center py-8">
      &copy; {currentYear} Your name here. All rights reserved.
      <div className="flex justify-center space-x-4 mt-4">
        <a href="https://m.webtoo.ls/@astro" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900">
        ...
        <a href="https://twitter.com/astrodotbuild" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900">
        ...
        <a href="https://github.com/withastro/astro" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900">
