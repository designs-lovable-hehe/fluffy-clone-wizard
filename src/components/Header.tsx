    ...
    <header className="bg-white shadow-md p-4">
      <nav className="flex items-center justify-between">
        ...
        <div className="flex space-x-4">
          <Link to="/" className="text-black no-underline border-b-4 border-transparent hover:border-accent">
            Home
          </Link>
          <Link to="/blog" className="text-black no-underline border-b-4 border-transparent hover:border-accent">
            Blog
          </Link>
          <Link to="/about" className="text-black no-underline border-b-4 border-transparent hover:border-accent">
            About
          </Link>
        </div>
        <div className="hidden md:flex space-x-4">
          <a href="https://m.webtoo.ls/@astro" target="_blank" rel="noopener noreferrer" className="text-black">
          ...
          <a href="https://twitter.com/astrodotbuild" target="_blank" rel="noopener noreferrer" className="text-black">
          ...
          <a href="https://github.com/withastro/astro" target="_blank" rel="noopener noreferrer" className="text-black">
